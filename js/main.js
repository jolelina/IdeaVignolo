...
window.onload = function() {
    ...
    if (usuarioGuardado) {
        ...
        mostrarBienvenida(usuarioRegistrado.nombre);
    }
}
...
function comprarCursos() {
    ...
    Swal.fire({
        title: 'Costo total de los cursos',
        text: `El costo total de los cursos en el carrito (IVA incluido) es: $${costoTotal.toFixed(2)}`,
        icon: 'success', 
